...
def my_seq2seq_args_parser():
    parser = argparse.ArgumentParser()


    parser.add_argument('--epochs', type=int, default=70, help='input dimension')
    ...
    parser.add_argument('--output_size', type=int, default=30, help='output dimension')
